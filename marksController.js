...
exports.saveMarks = (req, res) => {
    const { className, subject, testDate, topic, totalMarks, marks, batch, feedbacks, sub_code } = req.body;
    ...
    db.query('SELECT reg_no, name FROM students WHERE class = ?', [className], (error, students) => {
        ...
        const insertQuery = `
            INSERT INTO marks (reg_no, subject, marks, test_date, topic, total_marks, feedback, batch, sub_code)
            VALUES ?
